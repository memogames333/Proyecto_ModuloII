        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <header>
                        <h3 class="text-success"><i class="fa fa-user"></i> Administracion de reservaciones</h3>
                    </header>
                    <section>
                                ...
                                <tbody>
                                  <?php
                                    ...
                                    foreach ($query->result() as $arrQuery) {
                                      ...
                                      ?>
                                        <tr>
                                          <td><?=$arrQuery->id_reservacion; ?></td>
                                          <td><?=$arrQuery->nombre; ?></td>
                                          <td><?=$arrQuery->telefono; ?></td>
                                          <td><?=$arrQuery->numero_mesas; ?></td>
