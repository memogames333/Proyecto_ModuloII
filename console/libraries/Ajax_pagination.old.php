...
class Ajax_pagination{
	...
	var $per_page	 	= 6; // Max number of items you want shown per page
	...
	var $uri_segment	= 3;
	var $full_tag_open	= '<div class="pagination row col-md-12">';
	...
	function create_links(){
		...
		if ($num_pages == 1){
            		$info = 'Mostrando  : ' . $this->total_rows .' Registros';
			return $info;
		}
		...
		if ($this->show_count){
			...
			$info = '<div class="row col-md-12 justify-content-center"> Mostrando de ' . ( $curr_offset + 1 ) . ' Hasta ' ;
			...
			$info .= ' de ' . $this->total_rows .'&#160;&#160;</div><div class="row col-md-12 justify-content-center"><ul>';
